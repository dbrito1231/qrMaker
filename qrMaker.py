...
try:
    ...
    print("\n<~~~~ WiFi Details ~~~>")
    print("    SSID:   ".ljust(25), formattedData.SSID.item().strip())
    print("    Radio Type:    ".ljust(25), formattedData['Radio type'].item().strip())
    print("    Channnel:   ".ljust(25), formattedData.Channel.item().strip())
    print("    Signal Strength:   ".ljust(25), formattedData.Signal.item().strip())
    print("    Security:   ".ljust(25), formattedData.Authentication.item().strip(),'\n')
